...
function createReserveButton() {
    ...
    reserveButton.addEventListener('click', (event) => {
        ...
        (0,_utility_elementRender_js__WEBPACK_IMPORTED_MODULE_1__.changeButtonCover)('menu', 'contacts')
    });
