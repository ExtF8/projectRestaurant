...
function createContentLeft() {
    ...
    const leftImage = createImage(
        ...
        _homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].imageLeft
    );
...
function createStatsList() {
    ...
    for (let key in _homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].stats) {
        if (_homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].stats.hasOwnProperty(key)) {
            list.appendChild(createStatItem(_homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].stats[key]));
        }
    }
...
function createContentRight() {
    ...
    const rightImage = createImage(
        ...
        _homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].imageRight
    );
...
function createTitle(className) {
    ...
    title.textContent = _homeContents__WEBPACK_IMPORTED_MODULE_0__.homeContents[0].content.title;
